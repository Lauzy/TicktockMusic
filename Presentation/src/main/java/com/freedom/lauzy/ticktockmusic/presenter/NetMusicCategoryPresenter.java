...
import static com.lauzy.freedom.data.net.constants.NetConstants.Value.TYPE_JAZZ;
...
import static com.lauzy.freedom.data.net.constants.NetConstants.Value.TYPE_POPULAR;
...
public class NetMusicCategoryPresenter extends BasePresenter {
    ...
    public List<CategoryBean> getCategoryData(Context context) {
        int[] types = {TYPE_NEW, TYPE_HOT, TYPE_ROCK, TYPE_JAZZ, TYPE_POPULAR, TYPE_WESTERN,
        ...
        for (int i = 0; i < types.length; i++) {
            ...
            categoryBean.imgRes = R.mipmap.ic_launcher_round;
